<template>
    <div class="h-96">
        <h2 class="font-medium text-center text-lg">
            Utiliser des composants prêt à l'emploi dans vos projet d'application web
        </h2>
    ...
    <div class="mt-24">
        <div class="flex flex-col gap-4">
            <Button 
                :class="{ 'bg-primary border border-primary': activeSort === 'created_at', 'bg-transparent border border-primary': activeSort !== 'created_at' }"
                @click="activeSort = 'created_at'">
                Dernier ajout
            </Button>
            <Button 
                :class="{ 'bg-primary': activeSort === 'total_download', 'bg-transparent': activeSort !== 'total_download' }"
